        ...
        <div className="about-page-info container">
          <div className="about-page-content">
              ...
              <p>
                ...
                ensure your travel plans can go off without 
                a hitch. (Hitch costs extra 😉)
              </p>
              <p>
                Our team is full of vanlife enthusiasts who 
                know firsthand the magic of touring the 
                world on 4 wheels.
              </p>
          </div>
          <div className="about-page-cta">
              <h2>Your destination is waiting.<br />Your van is ready.</h2>
              <Link className="link-button about-page-button" to="/vans">Explore our vans</Link>
          </div>
        </div>
    </div>
  )
